...
emotionForm.forEach(form => {
  form.addEventListener('submit', function(event) {
    ...
    axios({
      method: 'post',
      url: `/groups/${groupId}/posts/${postId}/emotes/${emotionValue}/`,
      headers: {
...
commentArea.forEach(area => {
  ...
  commentLikeForm.addEventListener('submit', function(event) {
    ...
    axios({
      method: 'post',
      url: `/groups/${groupId}/posts/${postId}/comments/${commentId}/like/`,
      headers: {
        'X-CSRFToken': csrftoken,
      }
    })
    ...
    commentUpdateBtn.forEach(btn => {
      btn.addEventListener('click', function(event) {
        ...
        updateForm.addEventListener('submit', function(event) {
          ...
          axios({
            method: 'POST',
            url: `/groups/${groupId}/posts/${postId}/comment/${commentId}/update/`,
