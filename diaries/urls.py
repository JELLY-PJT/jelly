...
urlpatterns = [
    ...
    path('<int:group_pk>/<int:diary_pk>/comments/<int:comment_pk>/update/', views.comment_update, name='comment_update'),
    path('<int:group_pk>/<int:diary_pk>/comments/<int:comment_pk>/delete/', views.comment_delete, name='comment_delete'),
